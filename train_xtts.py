...
def train_voice(run_name: str, datasets_config: List[BaseDatasetConfig], training_dir: Path, batch_size: int = 9, rank: int = 0):
    ...
    # Training Parameters
    # TODO setup for multi gpu as option. This seems to cause memory issues.
    ...
    speakers: set[str] = {sample['speaker_name'] for sample in train_samples}
    ...
    print("DATASET SPEAKERS:", *speakers, sep=", ")
